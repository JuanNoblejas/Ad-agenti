...
class ShoppingFragment : Fragment() {
        ...
        adapter = ShoppingAdapter(
            ...
            onDelete = { item ->
                AlertDialog.Builder(requireContext())
                    ...
                    .setMessage("¿Estás seguro de que quieres eliminar \"${item.name}\"?")
    ...
    private fun setupButtons() {
        ...
        binding.btnDeleteChecked.setOnClickListener {
            AlertDialog.Builder(requireContext())
                .setTitle("Eliminar completados")
                .setMessage("¿Eliminar todos los artículos marcados como comprados?")
                .setPositiveButton("Eliminar") { _, _ ->
                    viewModel.deleteCheckedItems()
                    Toast.makeText(requireContext(), "Artículos eliminados", Toast.LENGTH_SHORT).show()
                }
                .setNegativeButton("Cancelar", null)
                .show()
        }
    ...
    private fun showAddItemDialog() {
        ...
        dialogBinding.btnAdd.setOnClickListener {
            ...
            if (itemName.isEmpty()) {
                dialogBinding.etItemName.error = "Escribe el nombre del artículo"
